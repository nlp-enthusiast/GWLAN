...
class Transformer(Module):
    ...
    def __init__(self,src_vocab_len,tgt_vocab_len, d_model: int = 512, nhead: int = 8, num_encoder_layers: int = 6,
        ...
        self.final_linear = nn.Linear(d_model,tgt_vocab_len)
        self._reset_parameters()

        self.src_emb_layer = nn.Embedding(src_vocab_len, d_model, padding_idx=0)
        xavier_uniform_(self.src_emb_layer.weight)
        self.tgt_emb_layer = nn.Embedding(tgt_vocab_len, d_model, padding_idx=0)
        xavier_uniform_(self.tgt_emb_layer.weight)
    ...
    def forward(self, src: Tensor, tgt: Tensor, src_mask: Optional[Tensor] = None, tgt_mask: Optional[Tensor] = None,
        ...
        src = self.pos_encoding(self.src_emb_layer(src))
        tgt = self.pos_encoding(self.tgt_emb_layer(tgt))
